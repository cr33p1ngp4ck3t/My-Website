    ...
    <html lang="en">
      ...
      <footer className="footer">
        ...
        <div>
          <div>
            <div>
              <Link className="logo" href="www.linkedin.com/in/creepingpacket" target="_blank"><img width="26" height="26" src="https://img.icons8.com/ios-filled/50/linkedin.png" alt="linkedin"/></Link>
